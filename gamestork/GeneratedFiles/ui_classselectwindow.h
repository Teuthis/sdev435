...
public:
    ...
    void setupUi(QDialog *ClassSelectWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/classIcon/cleric.png"), QSize(), QIcon::Normal, QIcon::Off);
        clericButton->setIcon(icon);
        clericButton->setIconSize(QSize(112, 112));
        ...
        QIcon icon1;
        icon1.addFile(QStringLiteral(":/classIcon/fighter.png"), QSize(), QIcon::Normal, QIcon::Off);
        fighterButton->setIcon(icon1);
        fighterButton->setIconSize(QSize(112, 112));
        ...
        QIcon icon2;
        icon2.addFile(QStringLiteral(":/classIcon/rogue.png"), QSize(), QIcon::Normal, QIcon::Off);
        rogueButton->setIcon(icon2);
        rogueButton->setIconSize(QSize(112, 112));
        ...
        QIcon icon3;
        icon3.addFile(QStringLiteral(":/classIcon/wizard.png"), QSize(), QIcon::Normal, QIcon::Off);
        wizardButton->setIcon(icon3);
        wizardButton->setIconSize(QSize(112, 112));
    ...
    void retranslateUi(QDialog *ClassSelectWindow)
    {
        ...
        clericButton->setText(QString());
        fighterButton->setText(QString());
        rogueButton->setText(QString());
        wizardButton->setText(QString());
