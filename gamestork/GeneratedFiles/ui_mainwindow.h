...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        unspentSkillsLabel->setGeometry(QRect(12, 144, 101, 16));
        ...
        unspentSkillsCountLabel = new QLabel(skillsGroup);
        unspentSkillsCountLabel->setObjectName(QStringLiteral("unspentSkillsCountLabel"));
        unspentSkillsCountLabel->setGeometry(QRect(114, 144, 16, 16));
        ...
        unspentFeatsLabel->setGeometry(QRect(12, 61, 82, 16));
        ...
        unspentFeatsCountLabel = new QLabel(featsGroup);
        unspentFeatsCountLabel->setObjectName(QStringLiteral("unspentFeatsCountLabel"));
        unspentFeatsCountLabel->setGeometry(QRect(94, 61, 16, 16));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        unspentSkillsLabel->setText(QApplication::translate("MainWindow", "Skill ranks remaining:", Q_NULLPTR));
        skillsRemove->setText(QApplication::translate("MainWindow", "-", Q_NULLPTR));
        unspentSkillsCountLabel->setText(QApplication::translate("MainWindow", "0", Q_NULLPTR));
        ...
        unspentFeatsLabel->setText(QApplication::translate("MainWindow", "Feats remaining:", Q_NULLPTR));
        featsRemove->setText(QApplication::translate("MainWindow", "-", Q_NULLPTR));
        unspentFeatsCountLabel->setText(QApplication::translate("MainWindow", "0", Q_NULLPTR));
